...
public class StateBasedApplication {
	...
	public HashMap<Integer, ApplicationState> getStateMap() {
		return stateMap;
	}
	
	public boolean isStateListItem(int ID) {
		return stateMap.get(ID).isListItem();
	}

	/**
	 * @return display name to be show on list
	 */
	public String getListDisplayName(int ID) {
		return stateMap.get(ID).getListDisplayName();
	}
